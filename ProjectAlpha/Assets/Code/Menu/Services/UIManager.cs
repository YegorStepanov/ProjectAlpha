...
namespace Code.Menu
{
    public sealed class UIManager
    {
        ...
        public async UniTaskVoid Show<TPanel>() where TPanel : struct, IPanel
        {
        ...
        {
            Type t when t == typeof(MainMenu) => PanelAddress.MainMenu,
            Type t when t == typeof(ShopPanel) => PanelAddress.ShopPanel,
            Type t when t == typeof(HeroSelectorPanel) => PanelAddress.HeroSelectorPanel,
            _ => throw new ArgumentOutOfRangeException(typeof(TPanel).FullName)
        };
    }
